    ...
    <header className={`header ${scrolled ? 'scrolled' : ''}`}>
      <div className="container header-container">
        ...
        <nav className={`nav-links ${isMenuOpen ? 'open' : ''}`}>
          ...
          <a href="https://discord.gg/coclipping" className="btn btn-primary nav-cta mobile-only">
            Discord
          </a>
        </nav>

        <a href="https://discord.gg/coclipping" className="btn btn-primary nav-cta desktop-only">
